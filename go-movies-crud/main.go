...
func main() {
	...
	movies = append(movies, initMovies()...)
...
func getMovies(w http.ResponseWriter, r *http.Request) {
	...
	// Encode the to be send response to json format instead of returning an entire file. The Front End now handles anything after receiving the JSON data.
